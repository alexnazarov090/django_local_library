...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_redirects_to_all_borrowed_book_list_on_success(self):
        ...
        response = self.client.post(reverse('catalog:renew-book-librarian',
    ...
    def test_form_invalid_renewal_date_past(self):
        ...
        response = self.client.post(reverse('catalog:renew-book-librarian', kwargs={'pk': self.test_bookinstance1.pk}), {'renewal_date': date_in_past})
        self.assertEqual(response.status_code, 200)
    ...
    def test_form_invalid_renewal_date_future(self):
        ...
        response = self.client.post(reverse('catalog:renew-book-librarian', kwargs={'pk': self.test_bookinstance1.pk}), {'renewal_date': invalid_date_in_future})
        self.assertEqual(response.status_code, 200)
...
class AuthorCreateViewTest(TestCase):
    ...
    def test_redirects_to_author_detail_view_on_success(self):
        ...
        response = self.client.post(reverse('catalog:author-create',),
                                    {'first_name': 'Santiago',
                                     'last_name': 'Gomez',
                                     'date_of_birth': '07/20/1950',
                                     'date_of_death': '10/10/2010'})
        self.assertEqual(response.status_code, 302)
